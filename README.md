...
This is a private Stackdrop repo — you need access to the `StackdropCO` GitHub org.

### Claude Code

```bash
gh repo clone StackdropCO/retool-classic-apps-skill \
  ~/.claude/skills/retool-classic-apps-skill
```
...
```bash
gh repo clone StackdropCO/retool-classic-apps-skill \
  .cursor/skills/retool-classic-apps-skill
```
...
```bash
git -C ~/.claude/skills/retool-classic-apps-skill pull
```
...
- Access to the `StackdropCO` GitHub org
...
Built by the team at [Stackdrop](https://stackdrop.co).
